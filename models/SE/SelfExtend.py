...
import models.SE.self_extend_patch as SE
...
def apply(loaded_model, group_size, window_size, enable_flash_attention=False, scale_base=-1, flash_attention_impl="triton", use_4_40 = False):
    '''
        loaded_model: 
    ...
    if 'Llama' in arch_name:
        ...
        if enable_flash_attention:
            if flash_attention_impl == "flash_attn":
                self_extend_attention_forward = partial(patch.flash_self_extend_forward,
                ...
                self_extend_attention_forward = partial(patch.flash_self_extend_forward_triton,
                                            group_size_1=group_size, 
                                            group_size_2=window_size,
                                            scale_base=scale_base)
            ...
            self_extend_attention_forward = partial(patch.self_extend_forward,
                                            group_size_1=group_size, 
                                            group_size_2=window_size,
                                            scale_base=scale_base)
